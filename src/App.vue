...
const query = ref('') // lo que pongamos en el search
const my_anime = ref([]) // lo que pongamos en la lista de animes
const search_results = ref([]) // lo que venga de la busqueda query
...
<template>
  <main>
    <h1>My Series/Films Favorites Tracker</h1>

    <form @submit.prevent="searchAnime">
      <input type="text" placeholder="Search film/serie ..." v-model="query" @input="handleInput" />
    ...
    <div class="results" v-if="search_results.length > 0">
      <div class="result" v-for="anime in search_results">
        ...
        <div class="details">
          ...
          <button @click="addAnime(anime)" class="button">Add to my favorites</button>
        </div>
      </div>
    </div>
